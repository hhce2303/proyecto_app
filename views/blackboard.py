"""
Blackboard - Clase base para contenedores de tabs del sistema.
Define estructura común: window, header, tabs, content_area.
Las subclases solo sobrescriben los métodos específicos.

Nombre: "Blackboard" (pizarra) - contenedor donde se organizan módulos
