    ...
    def _start_auto_refresh(self):
        ...
        def refresh_cycle():
            try:
                ...
                # Programar siguiente refresh en 0.15 minutos (9000 ms)
                self._refresh_job = self.container.after(9000, refresh_cycle)
            except Exception as e:
                print(f"[ERROR] refresh_cycle: {e}")
        
        # Iniciar primer ciclo después de 0.15 minutos
        self._refresh_job = self.container.after(9000, refresh_cycle)
